...
Tasbeeh Helper displays ads through Google AdMob. While we do not collect any data, Google AdMob may collect data to serve personalized ads. For more information on how Google AdMob collects and uses data, please review the [Google AdMob Privacy Policy](https://policies.google.com/privacy).
